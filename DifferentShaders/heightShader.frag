...
void main()
{
    ...
    float min_rock_slope = 0.2f;
    float max_grass_slope = 0.5f;
    float min_rockgrass_height = 0.1f;
    float max_sand_height = 0.28;
    ...
    temp =  mix(texture(sand_texture,TextureCoords*2000),temp,sand_rockgrass_weight*0.75);
